...
public class ContenedorEntrada extends VBox {
    ...
    public ContenedorEntrada() {
        ...
        Image imagen = new Image("/vista/imagenes/imagen_inicio.png", 1500, 150, true, true);
        ImageView imagenVista = new ImageView(imagen);

        Image fondo = new Image("/vista/imagenes/fondo_inicio.jpg", 525, 525, false, true);
    ...
    public void setBotonesIniciales(Stage stage) {
        ...
        Image jugar = new Image("/vista/imagenes/boton_jugar.png");
        ...
        Image salir = new Image("/vista/imagenes/boton_salir.png");
