...
public class CrearEspadachinEventHandler implements EventHandler<ActionEvent> {
    ...
    private static final String RUTA_SONIDO_ESPADACHIN = "src/vista/sonidos/crear_atacante.wav";
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        Media sound = new Media(new File(RUTA_SONIDO_ESPADACHIN).toURI().toString());
        (new MediaPlayer(sound)).play();
    }
}
